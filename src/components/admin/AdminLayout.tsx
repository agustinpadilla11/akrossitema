        ...
        <header className="h-16 bg-white border-b border-slate-200 flex items-center justify-between px-8 shrink-0 relative">
          ...
          <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
             <img src="/logo.png" alt="Akros Logo" className="h-10 object-contain" onError={(e) => {
               ...
               document.getElementById('header-logo-text-admin')?.classList.remove('hidden');
             }} />
             <h1 id="header-logo-text-admin" className="text-sm font-black uppercase tracking-widest text-slate-800 hidden">
